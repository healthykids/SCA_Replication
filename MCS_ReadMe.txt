...
This can be run all at once to dump the table for each configuration. Sources to parameters_mcsJL.R

'parameters_mcsJL.R'
Contains all the labels necessary for formatting and making the table readable and organized. Sources to 2_3 and 3_3
